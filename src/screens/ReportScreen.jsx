        ...
        <>
          ...
          {CATEGORIES.map((c) => (
            ...
            >
              ...
              {catId === c.id && (
                <span
                  style={{ marginLeft: "auto", color: c.color, fontSize: 18 }}
                >
                  ✓
                </span>
              )}
      ...
      {step === 3 && (
        <>
          ...
          <textarea
            ...
            placeholder="وصف المشكل بالتفصيل..."
            style={{
              width: "100%",
          ...
          <div
            ...
            style={{
              border: `2px dashed ${photo ? "#15803d" : "#d1d5db"}`,
              borderRadius: 10,
              padding: "18px",
              textAlign: "center",
              cursor: "pointer",
              background: photo ? "#f0fdf4" : "#fafafa",
              transition: "all 0.2s",
            }}
          >
            {photo ? (
              ...
              <div style={{ color: "#9ca3af" }}>
                📸 اضغط لتحميل صورة
                <br />
                <span style={{ fontSize: 11 }}>JPG, PNG — 5MB max</span>
              </div>
            )}
          </div>
